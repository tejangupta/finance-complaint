...
### Problem Statement
Complaints can give us insights into problems people are experiencing in the marketplace and help us understand the reason and make necessary modification in existing financial product if required.
...
The problem is to identify registered complaint will be disputed by a customer or not.
## Tech Stack Used
1. Python 
2. PySpark
3. PySpark ML
...
```
export AIRFLOW_HOME="/home/tejan/census_consumer_project/census_consumer_complaint/airflow"
```
...
```
airflow users create  -e tejangupta8@gmail.com -f Tejan -l Gupta -p admin -r Admin  -u admin
```
To start scheduler
```
airflow scheduler
