import os
from finance_complaint.constants.environment.variable_key import (AWS_SECRET_ACCESS_KEY_ENV_KEY,
...
class AWSConnectionConfig:
    ...
    def __init__(self, region_name):
        if AWSConnectionConfig.s3_resource is None or AWSConnectionConfig.s3_client is None:
