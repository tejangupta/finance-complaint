...
from finance_complaint.constants.prediction_pipeline_config.file_config import PYSPARK_S3_ROOT, S3_DATA_BUCKET_NAME
...
class PredictionPipeline:
    ...
    def read_file(self, file_path: str) -> DataFrame:
        try:
            ...
            df = spark_session.read.schema(self.schema.dataframe_schema).parquet(file_path)
